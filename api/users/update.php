...
if ($_SERVER['REQUEST_METHOD'] === 'PUT') {
    ...
    // Construct SQL query
    $sql = "UPDATE users SET Username=?, Firstname=?, Lastname=?, Contact_number=?, Country=?, Gender=?, Email=?, Usertype=?";
    $params = array($username, $firstname, $lastname, $contact_number, $country, $gender, $email, $usertype);
